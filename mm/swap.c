...
{
	/*
	 * For modern Android with zRAM/flash swap, page_cluster = 0 (no clustering)
	 * avoids decompressing unused pages, dramatically reducing swap latency and CPU overhead.
	 */
	page_cluster = 0;
}
